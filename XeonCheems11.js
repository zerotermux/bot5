                    ...
                    XeonBotInc.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://ibb.co.com/RyKScTs',
                                sourceUrl: wagc,
                                mediaType: 1,
                                renderLargerThumbnail: true
                            }
...
break
  ...
  await XeonBotInc.sendMessage(from, { image: medi, caption:"GALIRUS🇲🇨 : Nih Brek ! Done Ya !"}, { quoted: m })
...
await XeonStickWait()
 waifudd = await axios.get(`https://nekos.life/api/v2/img/spank`)     
            await XeonBotInc.sendMessage(m.chat, { caption:  `GALIRUS🇲🇨 : Nih Brek ! Done Ya !`, image: {url:waifudd.data.url} },{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'blowjob':
...
case 'blur':
 ...
 if (!isMedia) return replygcxeon("Where Is The Image")
                ...
                let anu = await TelegraPh(media)
                XeonBotInc.sendMessage(m.chat, {
                    image: { url: `https://vihangayt.me/maker/blur?url=${anu}` },caption: "GALIRUS🇲🇨 : Nih Brek ! Done Ya !" }, { quoted: m}) }
            break
            case 'beautiful':
  case 'beautifulimg': {
 if (!isMedia) return replygcxeon("Where Is The Image")
                ...
                let anu = await TelegraPh(media)
                XeonBotInc.sendMessage(m.chat, {
                    image: { url: `https://vihangayt.me/maker/beautiful?url=${anu}` },caption: "GALIRUS🇲🇨 : Nih Brek ! Done Ya !" }, { quoted: m}) }
            break
            case 'facepalm':
  case 'facepalmimage': {
 if (!isMedia) return replygcxeon("Where Is The Image")
                ...
                let anu = await TelegraPh(media)
                XeonBotInc.sendMessage(m.chat, {
                    image: { url: `https://vihangayt.me/maker/facepalm?url=${anu}` },caption: "GALIRUS🇲🇨 : Nih Brek ! Done Ya !" }, { quoted: m}) }
            break
            case 'invert':
  case 'invertimage': {
 if (!isMedia) return replygcxeon("Where Is The Image")
                ...
                let anu = await TelegraPh(media)
                XeonBotInc.sendMessage(m.chat, {
                    image: { url: `https://vihangayt.me/maker/invert?url=${anu}` },caption: "GALIRUS🇲🇨 : Nih Brek ! Done Ya !" }, { quoted: m}) }
            break
            case 'pixelate':
  case 'pixelateimage': {
 if (!isMedia) return replygcxeon("Where Is The Image")
                ...
                let anu = await TelegraPh(media)
                XeonBotInc.sendMessage(m.chat, {
                    image: { url: `https://vihangayt.me/maker/pixelate?url=${anu}` },caption: "GALIRUS🇲🇨 : Nih Brek ! Done Ya !" }, { quoted: m}) }
            break
            case 'rainbow':
  case 'rainbowimage': {
 if (!isMedia) return replygcxeon("Where Is The Image")
                ...
                let anu = await TelegraPh(media)
                XeonBotInc.sendMessage(m.chat, {
                    image: { url: `https://vihangayt.me/maker/rainbow?url=${anu}` },caption: "GALIRUS🇲🇨 : Nih Brek ! Done Ya !" }, { quoted: m}) }
            break
            case 'trigger':
  case 'triggerimage': {
 if (!isMedia) return replygcxeon("Where Is The Image")
                ...
                let anu = await TelegraPh(media)
                XeonBotInc.sendMessage(m.chat, {
                    image: { url: `https://vihangayt.me/maker/trigger?url=${anu}` },caption: "GALIRUS🇲🇨 : Nih Brek ! Done Ya !" }, { quoted: m}) }
            break
            case 'wanted':
  case 'wantedimage': {
 if (!isMedia) return replygcxeon("Where Is The Image")
                ...
                let anu = await TelegraPh(media)
                XeonBotInc.sendMessage(m.chat, {
                    image: { url: `https://vihangayt.me/maker/wanted?url=${anu}` },caption: "GALIRUS🇲🇨 : Nih Brek ! Done Ya !" }, { quoted: m}) }
            break
            case 'wasted':
  case 'wastedimage': {
 if (!isMedia) return replygcxeon("Where Is The Image")
                ...
                let anu = await TelegraPh(media)
                XeonBotInc.sendMessage(m.chat, {
                    image: { url: `https://vihangayt.me/maker/wasted?url=${anu}` },caption: "GALIRUS🇲🇨 : Nih Brek ! Done Ya !" }, { quoted: m}) }
            break
            case 'carbon':
  case 'carbonimage': {
 if (!text) return replygcxeon('Where is the text?')
                XeonBotInc.sendMessage(m.chat, {
                    image: { url: `https://vihangayt.me/maker/carbonimg?q=${text}` },caption: "GALIRUS🇲🇨 : Nih Brek ! Done Ya !" }, { quoted: m}) }
            break
            case 'colorize': {
 if (!isMedia) return replygcxeon("Where Is The Image")
                let media = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
                let anu = await TelegraPh(media)
                XeonBotInc.sendMessage(m.chat, {
                    image: { url: `https://vihangayt.me/tools/colorize?url=${anu}` },caption: "GALIRUS🇲🇨 : Nih Brek ! Done Ya !" }, { quoted: m}) }
            break
            case 'enhance': {
 if (!isMedia) return replygcxeon("Where Is The Image")
                let media = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
                let anu = await TelegraPh(media)
                XeonBotInc.sendMessage(m.chat, {
                    image: { url: `https://vihangayt.me/tools/enhance?url=${anu}` },caption: "GALIRUS🇲🇨 : Nih Brek ! Done Ya !" }, { quoted: m}) }
            break
            case 'dehaze': {
 if (!isMedia) return replygcxeon("Where Is The Image")
                let media = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
                let anu = await TelegraPh(media)
                XeonBotInc.sendMessage(m.chat, {
                    image: { url: `https://vihangayt.me/tools/dehaze?url=${anu}` },caption: "GALIRUS🇲🇨 : Nih Brek ! Done Ya !" }, { quoted: m}) }
            break
